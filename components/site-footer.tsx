    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex space-x-4">
          ...
          <Link href="#" className="text-custom-tan hover:text-white transition-colors">
            <Facebook className="w-5 h-5" />
          </Link>
          <Link href="#" className="text-custom-tan hover:text-white transition-colors">
            <Twitter className="w-5 h-5" />
          </Link>
          <Link href="https://www.instagram.com/brushedbybetty?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-custom-tan hover:text-white transition-colors">
            <Instagram className="w-5 h-5" />
          </Link>
          <Link href="https://youtube.com/@brushedbybetty?si=KkLOHRhAI7xoyUzE" className="text-custom-tan hover:text-white transition-colors">
            <Youtube className="w-5 h-5" />
          </Link>
          <Link href="https://vm.tiktok.com/ZMSTy5jY2/" className="text-custom-tan hover:text-white transition-colors">
            <TikTokIcon />
          </Link>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/about" className="text-custom-tan hover:text-white transition-colors">
              About Us
            </Link>
          </li>
          <li>
            <Link href="/courses" className="text-custom-tan hover:text-white transition-colors">
              Courses
            </Link>
          </li>
          <li>
            <Link href="/instructors" className="text-custom-tan hover:text-white transition-colors">
              Instructors
            </Link>
          </li>
          <li>
            <Link href="/portfolio" className="text-custom-tan hover:text-white transition-colors">
              Portfolio
            </Link>
          </li>
          <li>
            <Link href="/contact" className="text-custom-tan hover:text-white transition-colors">
              Contact
            </Link>
          </li>
        </ul>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/blog" className="text-custom-tan hover:text-white transition-colors">
              Blog
            </Link>
          </li>
          <li>
            <Link href="/faq" className="text-custom-tan hover:text-white transition-colors">
              FAQ
            </Link>
          </li>
          <li>
            <Link href="/termsofservice" className="text-custom-tan hover:text-white transition-colors">
              Terms of Service
            </Link>
          </li>
          <li>
            <Link href="/privacypolicy" className="text-custom-tan hover:text-white transition-colors">
              Privacy Policy
            </Link>
          </li>
        </ul>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-custom-tan">22 round about noah city point building 5th floor </span>
          </div>
          <div className="flex items-center space-x-3">
            <MapPin className="w-5 h-5 text-custom-tan" />
            <span className="text-custom-tan"> lebu mati building 3rd floor</span>
          </div>
           <div className="flex items-center space-x-3">
            <MapPin className="w-5 h-5 text-custom-tan" />
            <span className="text-custom-tan">  summit yetebaberut, Africa convention center</span>
          </div>
          <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-custom-tan">brushedbybetty@gmail.com</span>
          </div>
        </div>
      </div>
    </div>
