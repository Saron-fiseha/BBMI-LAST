    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-purple-50 overflow-hidden">
      <div className="container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <InteractiveHoverButton
                ...
                variant="outline"
                size="lg"
                className="text-lg px-8 py-4 border-0 border-golden-500 text-black-600 hover:bg-light-rose hover:text-white"
              >
                Join Now
              </InteractiveHoverButton>
            </div>
            ...
            <div className="flex items-center gap-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-light-rose">4500+</div>
                <div className="text-sm text-gray-600">Students Trained</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-slate-800">15+</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-warm-brown">98%</div>
                <div className="text-sm text-gray-600">Success Rate</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[400px] w-full sm:h-[500px] lg:h-[550px]">
            {/* Background Image */}
            <div className="absolute top-0 left-0 w-[80%] h-[80%] rounded-2xl overflow-hidden shadow-lg transform -rotate-3 transition-transform duration-500 hover:rotate-0">
              <Image
                src="https://i.pinimg.com/736x/0d/62/3a/0d623a9caa9d3540f9cbad09f7229581.jpg"
                alt="A collection of warm-toned makeup palettes and roses"
                layout="fill"
                objectFit="cover"
              />
            </div>
            {/* Foreground Image */}
            <div className="absolute bottom-0 right-0 w-[80%] h-[80%] rounded-2xl overflow-hidden shadow-2xl transform rotate-3 transition-transform duration-500 hover:rotate-0">
              <Image
                src="https://i.pinimg.com/736x/17/ca/e8/17cae895e1f4356f774df5548c404af0.jpg"
                alt="A woman having her makeup professionally applied"
                layout="fill"
                objectFit="cover"
              />
            </div>
