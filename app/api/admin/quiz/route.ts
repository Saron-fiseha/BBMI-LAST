...
//   try {
//     const rows: Record<string, any>[] = await db.query(
...
//         data.training_id,
//         data.question_text,
//         JSON.stringify(data.options), // <-- stringify the array
...
//        WHERE id = $4
//        RETURNING id, training_id, question_text, options, correct_answer_index`,
//       [data.question_text, JSON.stringify(data.options), data.correct_answer_index, data.id]
//     );
